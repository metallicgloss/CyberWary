# Generated by Django 4.0.2 on 2022-03-19 23:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage', models.DateField(null=True)),
                ...
                ('compromised', models.BooleanField(default=True)),
                ('browser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cyber_wary_portal.browser')),
                ('credential_check', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cyber_wary_portal.credentialscan')),
            ],
            options={
                'abstract': False,
            },
