    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('status', models.BooleanField(default=True)),
                ('check_for_signatures_before_running_scan', models.BooleanField(default=False, help_text='The flag associated with the automated check for signature updates before a scan is performed ().')),
                ...
                ('full_scan_on_battery_power', models.BooleanField(default=False, help_text='The flag to identify if full CPU performance while on battery power has been enabled ().')),
